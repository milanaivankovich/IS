...
var VideoMessage = function (props) {
    ...
    var progressOptions = {
        ...
        trailColor: '#aaa',
        trailWidth: 1,
        step: function (data, circle) {
            var _a, _b;
            circle.path.setAttribute('trail', (data.state !== undefined && ((_a = data === null || data === void 0 ? void 0 : data.state) === null || _a === void 0 ? void 0 : _a.color)) || '');
            circle.path.setAttribute('trailwidth-width', (data.state !== undefined && ((_b = data === null || data === void 0 ? void 0 : data.state) === null || _b === void 0 ? void 0 : _b.width)) || '');
    ...
    return (_jsxs("div", __assign({ className: classNames('rce-mbox-video', {
            'padding-time': !(props === null || props === void 0 ? void 0 : props.text),
                ...
                })) }, { children: [!downloaded && (_jsx("img", { src: props === null || props === void 0 ? void 0 : props.data.uri, alt: props === null || props === void 0 ? void 0 : props.data.alt, onClick: props.onOpen, onLoad: props.onLoad, onError: props.onPhotoError })), downloaded && (_jsxs("video", __assign({ controls: true, controlsList: props.controlsList }, { children: [_jsx("source", { src: props === null || props === void 0 ? void 0 : props.data.videoURL, type: 'video/mp4' }), "Your browser does not support HTML video."] }))), error && (_jsx("div", __assign({ className: 'rce-mbox-video--video__block' }, { children: _jsx("span", __assign({ className: 'rce-mbox-video--video__block-item rce-mbox-video--error' }, { children: _jsx(HugeiconsIcon, { icon: Alert02Icon }) })) }))), !error && ((_e = props === null || props === void 0 ? void 0 : props.data) === null || _e === void 0 ? void 0 : _e.status) && !downloaded && (_jsxs("div", __assign({ className: 'rce-mbox-video--video__block' }, { children: [!props.data.status.click && (_jsx("button", __assign({ onClick: props.onDownload, className: 'rce-mbox-video--video__block-item rce-mbox-video--download' }, { children: _jsx(HugeiconsIcon, { icon: CloudDownloadIcon }) }))), typeof props.data.status.loading === 'number' && props.data.status.loading !== 0 && (_jsx(ProgressCircle, { animate: props.data.status.loading, className: 'rce-mbox-video--video__block-item', progressOptions: progressOptions }))] })))] })), (props === null || props === void 0 ? void 0 : props.text) && _jsx("div", __assign({ className: 'rce-mbox-text' }, { children: props.text }))] })));
};
