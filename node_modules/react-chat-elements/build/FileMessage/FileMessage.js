...
var FileMessage = function (props) {
    ...
    return (_jsx("div", __assign({ className: 'rce-mbox-file' }, { children: _jsxs("button", __assign({ onClick: onClick }, { children: [_jsxs("div", __assign({ className: 'rce-mbox-file--icon' }, { children: [_jsx(HugeiconsIcon, { icon: File01Icon, color: '#aaa' }), _jsx("div", __assign({ className: 'rce-mbox-file--size' }, { children: props === null || props === void 0 ? void 0 : props.data.size }))] })), _jsx("div", __assign({ className: 'rce-mbox-file--text' }, { children: props.text })), _jsxs("div", __assign({ className: 'rce-mbox-file--buttons' }, { children: [error && (_jsx("span", __assign({ className: 'rce-error-button' }, { children: _jsx(HugeiconsIcon, { icon: Alert02Icon, color: '#ff3d3d' }) }))), !error && ((_c = props === null || props === void 0 ? void 0 : props.data) === null || _c === void 0 ? void 0 : _c.status) && !((_d = props === null || props === void 0 ? void 0 : props.data) === null || _d === void 0 ? void 0 : _d.status.download) && !((_e = props === null || props === void 0 ? void 0 : props.data) === null || _e === void 0 ? void 0 : _e.status.click) && (_jsx(HugeiconsIcon, { icon: CloudDownloadIcon, color: '#aaa' })), !error &&
